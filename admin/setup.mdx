---
title: "Configure Absolet with the /setup Dashboard"
sidebarTitle: "Setup Dashboard"
description: "The /setup command opens an interactive in-Discord settings dashboard with categories for tickets, suggestions, welcome/goodbye, economy, verification, levels, filters, starboard, and sticky roles."
---
...
| **Daily Reward** | Number | `1000` | Coins awarded when a user runs `/daily` (resets every 24 hours). |
| **Weekly Reward** | Number | `2500` | Coins awarded when a user runs `/weekly` (resets every 7 days). |
| **Max Money** | Number | `250` | The maximum coins a user can earn from a single `/work` use. |
| **Min Money** | Number | `100` | The minimum coins a user can earn from a single `/work` use. |
